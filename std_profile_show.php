...
<div class="container">
      ...
      <div class="card text-center font_1 border border-dark border-1">
        ...
        <div class="card-body"> 
          ...
          <form name="form1" method="post" action="std_profile_edit.php?sub_id=">
            <div class="form-group">
              <div class="container font_1">
                <div class="col-lg-auto" >
            
                  <div class="text-center">
                      <img src="assets/pic_student/p1.png" alt="user" width="200" height="200" class="border border-dark img-thumbnail rounded mx-auto d-block" > 
                  </div>
